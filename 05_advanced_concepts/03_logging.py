...
if __name__ == "__main__":
    ...
    dev1 = method_decorators.Developer(first='Hadley', last='Wickham', pay=90000, prog_lang='R')
    emp1 = method_decorators.Employee(first='John', last='Doe', pay=50000)
    emp2 = method_decorators.Manager(first='Lex', last='Luthor', pay=100000, employees=[dev1])
    print(dev1.__dict__)
